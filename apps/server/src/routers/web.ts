...
export const webRouter = base
	...
	.router({
		dashboard: base
			...
			.output(z.object({ hosts: z.array(hostWithRightsSchema), vms: z.array(vmSchema), messages: z.array(messageSchema), managedDatabases: z.array(managedDatabaseWithBackupsSchema), availability: maintenanceStatus, maintenance: maintenanceStatus}))
			.handler(async () => {
